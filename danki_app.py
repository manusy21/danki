...
def query_gemini(word):
    ...
    prompt = (
        ...
        "If the word is not a valid Spanish word, return this JSON exactly:\n"
        "{\"error\": \"Not a valid Spanish word\"}\n\n"
        "1. **base_s**: The original Spanish word\n"
        "2. **base_e**: The English translation(s)\n"
        "3. **articulo_s**: The definite article if the word is a noun (e.g., \"el\", \"la\"). Leave empty if not a noun.\n"
        "4. **plural_s**: The plural form (for nouns). Leave empty if not a noun.\n"
        "5. **presente**: Present tense (3rd person singular), e.g., \"corre\"\n"
        "6. **preterito**: Simple past tense (3rd person singular), e.g., \"corrió\"\n"
        "7. **participio**: Past participle or compound form, e.g., \"ha corrido\"\n"
        "8. **full_s**: A combined string of the above three conjugation forms, e.g., \"corre, corrió, ha corrido\"\n"
        "9. **s1**: A natural Spanish sentence using the word, with its English translation in parentheses.\n"
        ...
        "  \"presente\": \"corre\",\n"
        "  \"preterito\": \"corrió\",\n"
        "  \"participio\": \"ha corrido\",\n"
        "  \"full_s\": \"corre, corrió, ha corrido\",\n"
        "  \"s1\": \"Yo corro todos los días. (I run every day.)\",\n"
        "  \"s2\": \"Él corre al trabajo. (He runs to work.)\",\n"
        "  \"s3\": \"El perro corre por el jardín. (The dog runs through the garden.)\"\n"
        "}\n"
        "```"
    )
